     ...
     <Disclosure as="nav" className="bg-white shadow-md w-full  ">
      <div className="mx-auto max-w-7xl  sm:px-6 lg:px-8 xl:px-0 ">
        <div className="flex h-16 items-center justify-between">
          ...
          <a href="/contact" className='lg:hidden font-bold text-[10px] px-1 rounded bg-black text-white py-1 items-center ml-40 sm:ml-70'>Book A Demo</a>
        ...
        <div className="space-y-1 px-4 pt-2 pb-3">
          {navigation.map((item) => (
            <DisclosureButton
              ...
              href={item.href}
              className={classNames(
                item.current ? 'bg-gray-900 text-white' : 'text-gray00 hover:bg-gray-700 hover:text-white',
